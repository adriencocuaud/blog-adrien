...
(function () {
    ...
    var SPEED_MODES = {
        lent: { inspection: 6000, tempo: 1.2 },
        moyen: { inspection: 4000, tempo: 2.2 },
        rapide: { inspection: 2000, tempo: 3.5 }
    };
    var SPEED_DEFAULT = 'moyen';
    var NEXT_PAUSE = 200; // pause après la durée de l'algo, avant le cas suivant
    var AUF_PAUSE = 500; // pause entre la rotation AUF jouée et l'algo de résolution
